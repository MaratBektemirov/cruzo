...
declare class ComponentsRegistryService {
    ...
    constructor();
    removeComponents(components: ComponentsList): void;
    define(constructor: AbstractComponentConstructor): void;
    connectBySelector(selector: string, componentsList: ComponentsList, rootNode?: ParentNode, rule?: RuleCompleted): import("./component").AbstractComponent<any, any>[];
    initApp(): void;
