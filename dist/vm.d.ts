...
export declare class Bytecode {
    ...
    private exprCount;
    private onceCount;
    constructor(code: Uint32Array, consts: any[], idNames: string[], exprCount: number, onceCount: number);
    onlyOnce(): boolean;
    ...
    run(template: any, ctx: number, linkIndex: number, app: any, rxAccIsFilling: boolean, event: Event): any;
}
